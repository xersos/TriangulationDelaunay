...
vector<Vector3D*> DotGenerator::GetSphericalDots()
{
    int dotCount;
    cout << "Dot Count: ";
    cin >> dotCount;

    ofstream file("ile.txt");
...
Vector3D* DotGenerator::GetRandomDot()
{
...
Vector3D* DotGenerator::GetRandomDotEvenlyDistributed()
{
